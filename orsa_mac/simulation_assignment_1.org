...
#+name: ff_sim
#+begin_src R :var runs=100000 :session :exports both
...
#+begin_src R :session :results output graphics file :exports both
library(ggplot2)
...
#+name: missile_sim
#+begin_src R :session :var runs=100000 :exports both :results table
set.seed(123)
